...
public class GameServiceTests {
    private GameService service = new DefaultGameService(IoC.gameRepository(), new MockUserRepository());
...
//
//        AggregateId id = service.createGame(annId,5, 5);
//
//        service.joinToGame(jonId, id);
//
//        service.start(id);
//
...
//
//        AggregateId id2 = service.createGame(jonId, 5, 5);
//
